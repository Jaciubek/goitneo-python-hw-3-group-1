...
def main():
    global_file_name = 'address_book.dat'
    book = load_address_book_from_file(global_file_name)
    ...
    while True:
        ...
        if cmd == "add":
            ...
            print("Goodbye!")
            book.save_to_file(global_file_name)
